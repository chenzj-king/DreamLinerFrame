...
public abstract class BaseCompatFragment extends Fragment implements LifecycleProvider<FragmentEvent>, ISupportFragment {
    ...
    protected View view;
    protected BaseCompatActivity mContext;
    ...
    public void onAttach(Activity activity) {
        ...
        mContext = (BaseCompatActivity) activity;
    ...
    public static class MyHandler extends android.os.Handler {
        ...
        private WeakReference<BaseCompatFragment> mWeakReference;

        public MyHandler(BaseCompatFragment weakReference) {
        ...
        public void handleMessage(Message msg) {
            ...
            BaseCompatFragment baseCompatFragment = mWeakReference.get();
